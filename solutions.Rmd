...
## Exercise I
 ...
 All you need to do is to replace the filename `raw_counts.txt` with each of the different files to look at the differences between different normalization methods.
