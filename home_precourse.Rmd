...
install.packages(c("ggplot2","tidyverse","pheatmap","devtools","cowplot",
...
<i class="fas fa-exclamation-circle"></i> The data that is necessary for this course is available [here](https://nbisweden.github.io/workshop-data-visualization-r/2210/data/data.zip) and it is important to check that the `file-tree` looks OK.
