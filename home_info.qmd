...
The lunches during the course will be provided at **Stamstället** located at the same building as the course. The restaurant menu can be found [here](https://stamstallet.se/lunch/).
