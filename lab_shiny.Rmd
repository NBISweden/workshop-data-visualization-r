...
```{r,echo=FALSE,out.class="md",comment="", fold.output=FALSE, fold.plot=FALSE}
...
Here is an example of how you build an app from scratch. Please follow the instructions in this [exercise](lab_shiny3.html)
