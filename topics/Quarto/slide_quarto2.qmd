...
- Dashboards are a great way to present data in a visually appealing format
- A new output format for creating dashboards from notebooks/ `.qmd` files
<br>

**Key Quarto dashboard features:**
<br>

- **Component flexibility:** static graphics, interactive widgets, tabular data, value boxes, text annotations...
- **Markdown syntax:** authoring with any text editor
- **Compatibility with other languages:** R, Python, Julia
- **Costumization options:** themes, logos, colors...
- **Resizing:** optimal display on devices of all sizes
<br>
<br>
