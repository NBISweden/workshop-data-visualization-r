...
:::{.callout-note}
To run the following example, you need to download the data `dream_location_filt.csv`. Unfortunately, this was not part of the `data.zip` you recieved in the beginning of the course. You can download this file [here](https://github.com/NBISweden/workshop-data-visualization-r/raw/main/topics/dynamic_plotting/data/bcg-immunization-coverage-for-tb-among-1-year-olds.csv) 
:::
