...
* A phylogentic tree based on a group of archaeal genomes in newick format: [Archaea tree](https://github.com/NBISweden/workshop-data-visualization-r/raw/main/data/arch_newick.txt)
