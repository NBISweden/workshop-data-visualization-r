...
* [Interactive Notebooks](https://quarto.org/docs/interactive/shiny/)
...
- From Qmd file using `quarto render app.qmd`
                ...
                tabPanel("tab1",
                         fluidRow(
                           ...
                           column(6,
                                  helpText("Col2"),
                                  fluidRow(
                                    column(4,style="background-color:#b0c6fb",helpText("Col2.1")),
                                    column(4,style="background-color:#ffa153",helpText("Col2.2")),
                                    column(4,style="background-color:#b1f6c6",helpText("Col2.3"))
                                  )
                           )
                         )
                ),
...
Slide inspirations: Roy Francis (NBIS, RaukR2025)
