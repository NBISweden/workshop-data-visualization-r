...
The workshop is online only. Zoom, HackMD and Slack links are sent to participants by email.
...
```{r,eval=FALSE,echo=FALSE,block.title=NULL}
...
```{r,eval=FALSE,echo=FALSE,results="asis",block.title=NULL}
cat(dfr$description)
```
...
If you would like to get in touch with us regarding the course at GitHub, kindly write to us at the [issues](https://github.com/NBISweden/workshop-plotting-in-r/issues) page.
