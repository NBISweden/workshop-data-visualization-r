...
if(loc=="solna") {
  dfr <- data.frame(venue_lat=59.350451,
                    venue_lon=18.023393,
                    venue_address="<b>SciLifeLab</b>, Tomtebodavägen 23, 171 65 Solna",
                    description="Use the [Stockholms Län trafiken website](https://www.sl.se) or the [Stockholms Län trafiken app](https://sl.se/sl/om-sl/om-sl-appen) for bus services around Stockholm. You can find more information about the site [here](https://www.scilifelab.se/community-pages/at-campus-solna/).",
                    stringsAsFactors=F)
}
```
