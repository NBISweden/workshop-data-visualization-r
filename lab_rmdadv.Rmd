...
```{r,echo=FALSE,comment=""}
cat(paste0("```{r,accordion=TRUE,btn.type='optional'}\n","Sys.Date()\n","``` \n"))
```
...
```{r,echo=FALSE,comment=""}
cat(paste0("```{r,accordion=TRUE,btn.type='success'}\n","Sys.Date()\n","``` \n"))
```
...
```{r,echo=FALSE,comment=""}
cat(paste0("```{r,accordion=TRUE,btn.type='warning'}\n","Sys.Date()\n","``` \n"))
```
...
```{r,echo=FALSE,comment=""}
cat(paste0("```{r,accordion=TRUE,btn.type='danger'}\n","Sys.Date()\n","``` \n"))
```
...
```{r,echo=FALSE,comment=""}
cat(paste0("```{r,accordion=TRUE,btn.type='info'}\n","Sys.Date()\n","``` \n"))
```
...
Here are examples of accordions inside custom divs.
...
<p>
<button class="btn btn-sm btn-collapse-optional btn-collapse btn-collapse-normal collapsed" type="button" data-toggle="collapse" data-target="#task-sum" aria-expanded="false" aria-controls="task-sum">
</button>
</p>
